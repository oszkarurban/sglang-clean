...
class DetokenizerManager(MultiHttpWorkerDetokenizerMixin):
    ...
    def handle_batch_token_id_out(self, recv_obj: BatchTokenIDOutput):
        ...
        return BatchStrOutput(
            ...
            spec_draft_tokens=recv_obj.spec_draft_tokens,
            spec_accepted_tokens_log=recv_obj.spec_accepted_tokens_log,
            spec_rejected_tokens_log=recv_obj.spec_rejected_tokens_log,
            spec_accept_index_log=recv_obj.spec_accept_index_log,
            spec_topk=recv_obj.spec_topk,
            spec_num_steps=recv_obj.spec_num_steps,
