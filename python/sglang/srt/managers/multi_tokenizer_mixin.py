...
def _handle_output_by_index(output, i):
    ...
    if isinstance(output, BatchTokenIDOutput):
        new_output = BatchTokenIDOutput(
            ...
            spec_logged_topk=_extract_field_by_index(output, "spec_logged_topk", i),
            spec_logged_num_steps=_extract_field_by_index(output, "spec_logged_num_steps", i),
            spec_logged_draft_token_num=_extract_field_by_index(output, "spec_logged_draft_token_num", i),
            spec_logged_threshold_single=_extract_field_by_index(output, "spec_logged_threshold_single", i),
